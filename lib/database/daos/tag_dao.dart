...
class TagDao extends DatabaseAccessor<AppDatabase> with _$TagDaoMixin {
  ...
  Future<int> assignTagToContent(ContentTagsCompanion contentTag) =>
      into(contentTags).insert(contentTag);

  Future<int> removeTagFromContent(String contentId, String tagId) {
    return (delete(contentTags)
          ..where((t) => t.contentId.equals(contentId) & t.tagId.equals(tagId)))
        .go();
  }
}
