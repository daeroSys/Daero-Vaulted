...
class SyncDao extends DatabaseAccessor<AppDatabase> with _$SyncDaoMixin {
  ...
  Future<List<SyncQueueData>> getPendingSyncItems() {
    return (select(syncQueue)
          ...
          ..orderBy([
            ...
            ), // Requires proper enum mapping logic in SQL if relying on strings, but we can sort in Dart later if needed.
  ...
  Future<bool> updateSyncItem(SyncQueueCompanion item) =>
